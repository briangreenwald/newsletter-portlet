 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.liferay.training.newsletter.service.IssueLocalService} interface.
 *
 * <p>
...
public class IssueLocalServiceImpl extends IssueLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link com.liferay.training.newsletter.service.IssueLocalServiceUtil} to access the issue local service.
	 */
	
	public Issue addIssue(long groupId, long companyId, long userId, 
		String userName, int issueNo, String title, String description, int issueMonth, 
		int issueYear, String byline) throws SystemException {
	...
	public Issue updateIssue(long issueId, long groupId, long companyId, 
		long userId, String userName, int issueNo, String title, 
		String description, int issueMonth, int issueYear, String byline) {
